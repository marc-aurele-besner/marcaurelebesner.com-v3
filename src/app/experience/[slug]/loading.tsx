...
export default function Loading() {
  return (
    <div className="max-w-4xl mx-auto py-8">
      <div className="h-6 w-40 animate-pulse bg-slate-200 dark:bg-slate-700 rounded mb-8" />

      <GlassCard className="p-8 lg:p-12">
        <header className="mb-8 pb-8 border-b border-slate-200 dark:border-white/10">
          <div className="h-10 w-72 animate-pulse bg-slate-200 dark:bg-slate-700 rounded mb-2" />
          <div className="h-6 w-48 animate-pulse bg-slate-200 dark:bg-slate-700 rounded mb-4" />
          <div className="flex flex-wrap gap-4 text-sm">
            <div className="h-5 w-32 animate-pulse bg-slate-200 dark:bg-slate-700 rounded" />
            <div className="h-5 w-24 animate-pulse bg-slate-200 dark:bg-slate-700 rounded" />
        ...
        <div className="space-y-4">
          ...
          <div className="h-8 w-40 animate-pulse bg-slate-200 dark:bg-slate-700 rounded mt-8 mb-4" />

          <div className="space-y-3">
            <div className="flex items-start gap-3">
              <div className="h-5 w-5 animate-pulse bg-slate-200 dark:bg-slate-700 rounded flex-shrink-0 mt-0.5" />
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <div className="h-7 w-14 animate-pulse bg-slate-200 dark:bg-slate-700 rounded-full" />
          </div>
        </div>
      </GlassCard>
      ...
      <div className="flex justify-between mt-8 gap-4">
        <GlassCard className="flex-1 p-4">
          ...
          <div className="h-5 w-32 animate-pulse bg-slate-200 dark:bg-slate-700 rounded mb-1" />
        ...
        <GlassCard className="flex-1 p-4">
          ...
          <div className="h-5 w-28 animate-pulse bg-slate-200 dark:bg-slate-700 rounded mb-1 ml-auto" />
          <div className="h-4 w-20 animate-pulse bg-slate-200 dark:bg-slate-700 rounded ml-auto" />
        </GlassCard>
      </div>
    </div>
  );
