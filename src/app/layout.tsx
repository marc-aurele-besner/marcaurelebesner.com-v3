      ...
      >
        <ThemeProvider>
          ...
          <div className="flex min-h-screen md:flex-row flex-col">
            <aside className="md:w-72 bg-white/70 dark:bg-cyber-dark/80 backdrop-blur-xl border-r border-slate-200 dark:border-cyber-blue/20 p-8 fixed h-full hidden md:block shadow-[4px_0_20px_rgba(0,217,255,0.1)]">
              <Menu />
            </aside>
            <main id="main-content" className="flex-1 overflow-y-auto py-16 md:ml-72 px-4 sm:px-6 lg:px-8 relative">
              {children}
            </main>
          </div>
        </ThemeProvider>
