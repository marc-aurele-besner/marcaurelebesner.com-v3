...
export const Project: FC<ProjectData> = ({
  ...
  projectType,
    ...
    <div
      className="flex flex-col md:flex-row items-center border-2 border-lightCyan p-6 rounded-lg mt-6"
    >
      <a href={link} target="_blank" rel="noopener noreferrer" className="w-full md:w-1/3">
        <div className="flex flex-col items-center">
          ...
          />
          <button className={`inline-block px-3 py-1 text-xs sm:text-sm font-semibold rounded-full border-2 mt-2 ${
